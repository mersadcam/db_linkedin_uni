...
from db import DB
from consts import Messages, DB_NAME, debug
import constants
...
class Mainwindow(QMainWindow):
    ...
    def switch_to_own_profile(self, event):
        ...
        self.profile.set_name(self.own_profile_data['profile_first_name'],
                              self.own_profile_data['profile_last_name'])
        self.profile.set_headline_label(self.own_profile_data['profile_headline'])
    ...
    def switch_to_home(self):
        ...
        self.ui.firstname_label.setText(self.own_profile_data['profile_first_name'])
        self.ui.lastname_label.setText(self.own_profile_data['profile_last_name'])

        if self.own_profile_data['profile_headline'] is None:
            self.ui.headline_plainTextEdit.setPlainText(Messages.DEFAULT_HEAD_LINE)
        else:
            self.ui.headline_plainTextEdit.setPlainText(self.own_profile_data['profile_headline'])
